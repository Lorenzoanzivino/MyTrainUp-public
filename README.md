...
_Nota: Per motivi di sicurezza, i file di configurazione sensibili (.env), i database reali e gli script di deploy automatizzati sono esclusi da questa repository pubblica_
